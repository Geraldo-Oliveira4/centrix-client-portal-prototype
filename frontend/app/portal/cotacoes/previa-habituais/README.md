...
Roteiro manual restante: preencher as datas pelo navegador, revisar, testar nenhum agente selecionado e confirmação, concluir simulação. No histórico, escolher Nova remessa e conferir ausência de PO/datas/ofertas; por fornecedor, variar Hanwha/Daehan. Validar mobile e acessibilidade antes de publicação.
