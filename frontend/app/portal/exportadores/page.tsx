...
/**
 * Rota antiga, mantida como redirect. "Meus Exportadores" deixou de ser item de
 ...
 */
export default function PortalExportadoresRedirectPage() {
  redirect('/portal/preferencias/exportadores');
}
